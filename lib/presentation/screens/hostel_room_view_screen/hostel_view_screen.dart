...
class HostelViewScreen extends StatelessWidget {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              HostelRoomTopView(accommodation, context),
                              SizedBox(
                                height: 37,
                              ),
                              CustomReviewSection(context: context),
                              SizedBox(
                                height: 37,
                              ),
                              HotelRoomsRoomsView(rooms)
                            ],
                          ),
                        ),
                      ],
  ...
  Container HotelRoomsRoomsView(List<Room> rooms) {
    return Container(
                  ...
                  children: [
                    Slidable(
                      ...
                      endActionPane: ActionPane(
                        motion: ScrollMotion(),
                        extentRatio: 1,
                        children: [RequestBookingHostelLogic(room)],
                      ),
                      child: HostelRoomRoomCard(room),
                    ),
                    SizedBox(
                      height: 10,
                    ),
  ...
  Container HostelRoomRoomCard(Room room) {
    return Container(
      child: Row(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        room.fan_availability == true ? "Has Fan" : "No Fan",
                        style: TextStyle(
                            color: UsedColors.mainColor,
                            fontSize: 12,
                            fontWeight: FontWeight.w600),
  ...
  SlidableAction RequestBookingHostelLogic(Room room) {
    return SlidableAction(
      onPressed: (context) async {
        if (context.read<UserDetailsStorageBloc>().state.isLoggedIn == false) {
          showPopup(
              context: context,
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        context.read<RequestBookingCubit>()
                          ..requestBooking(
                              token: loginState.user!.token!, roomId: room.id!);
