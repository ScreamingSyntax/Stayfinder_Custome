...
class Room {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'room_images': room_images!.map((x) => x?.toMap()).toList(),
    };
  }
  ...
  factory Room.fromMap(Map<String, dynamic> map) {
    return Room(
      ...
      room_images: map['room_images'] != null
          ? List<RoomImage?>.from(
              (map['room_images'] as List<dynamic>).map<RoomImage?>(
                (x) => RoomImage?.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
    );
  ...
  bool operator ==(covariant Room other) {
    ...
    return other.id == id &&
        ...
        listEquals(other.room_images, room_images);
  }
